...
// Tests for CaseTester Test method
func TestCaseTesterDefault_Test(t *testing.T) {
	t.Run("case 1: success to test", func(t *testing.T) {
		...
		// - tester
		ts := internal.NewCaseTesterDefault(db, rq, rp)
	...
	t.Run("case 2: fail to test - database set-up", func(t *testing.T) {
		...
		// ...
		// - tester
		ts := internal.NewCaseTesterDefault(db, nil, nil)
	...
	t.Run("case 4: fail to test - requester", func(t *testing.T) {
		...
		// ...
		// - tester
		ts := internal.NewCaseTesterDefault(db, rq, nil)
